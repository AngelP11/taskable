...
function Register() {
  ...
  const [setDia] = useState(0); // valor del dia seleccionado
  const [setMes] = useState("");
  const [setAnio] = useState(0);
  const [password, setPassword] = useState(null);
  const [setPassword_confirmation] = useState(null);
    ...
    >
      <Grid item className={classes.content}>
        <Card className={classes.card} variant="outlined">
          <CardContent>
            ...
            <Typography variant="body2" className={classes.text} component="p">
              Regístrate en Taskble con tus datos
            </Typography>
            ...
            <div className={classes.inputContainer}>
              ...
              <Typography className={classes.fechanac}>
                Fecha de nacimiento
              </Typography>
              <Grid container spacing={3} style={{ marginBottom: 8 }}>
                <Grid item xs={3}>
                  ...
                  <Fade {...TransitionProps} timeout={350}>
                    <Card className={classes.paper} raised={false}>
                      <CardContent>
                        ...
                        <Typography
                          className={rule1 ? classes.isValid : null}
                          component="p"
                          variant="caption"
                          gutterBottom
                        >
                          <CheckCircleOutline style={{ fontSize: 12 }} /> 8
                          caracteres como mínimo
                        </Typography>
                        <Typography
                          className={rule2 ? classes.isValid : null}
                          component="p"
                          variant="caption"
                          gutterBottom
                        >
                          <CheckCircleOutline style={{ fontSize: 12 }} /> Letras
                          mayúsculas y minúsculas
                        </Typography>
                        <Typography
                          className={rule3 ? classes.isValid : null}
                          component="p"
                          variant="caption"
                          gutterBottom
                        >
                          <CheckCircleOutline style={{ fontSize: 12 }} /> Al
                          menos un número
                        </Typography>
                      </CardContent>
                    </Card>
        ...
        <Typography
          ...
          gutterBottom
        >
          Al dar click en "Crear cuenta" estás aceptando los{" "}
          <Link to="/terminos">términos y condiciones</Link> de Taskble LLC
        </Typography>
      </Grid>
    </Grid>
  );
