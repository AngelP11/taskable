...
export default function Lista() {
  ...
  const openDetailedList = () => (e) => {
    ...
    e.target.parentNode.parentNode.style =
      "display: flex; justify-content: space-between; border-top: 1px solid #2979ff; border-bottom: 1px solid #2979ff; border-left: 1px solid #2979ff;";

    setIsShowedDetailedList(true);
    setListWidth(6);
  };

  const handleToggle = (index, task) => () => {
